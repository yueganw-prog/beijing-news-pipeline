...
import { getStatsBySource, getPipelineRuns, getArticles, getArticle } from "./api.js";
...
export const Icons = {
  ...
  globe: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h10"/></svg>',
...
export const catLabels = { tech: "科技", finance: "财经", local: "本地" };
